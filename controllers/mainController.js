...
const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: "kachhadiyagautam54@gmail.com",
        pass: "hbzpzsfrcycyfvlg",
    },
});
...
//         res.redirect('/signUp');
//         console.log("admin Don't created");
//     }
// }
...
const findUser = (req, res) => {
    ...
    adminModel.findOne({ email }).then((user) => {
        ...
        // Email data
        const mailOptions = {
            from: 'kachhadiyagautam54@gmail.com',
            to: user.email,
...
const newPass = async (req, res) => {
    ...
    // console.log("id", id);
    // console.log("Data", npassword, cpassword);
